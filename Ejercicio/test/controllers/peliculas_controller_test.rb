...
class PeliculasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pelicula" do
    assert_difference('Pelicula.count') do
      post peliculas_url, params: { pelicula: { calificacion: @pelicula.calificacion, duracion: @pelicula.duracion, genero: @pelicula.genero, nombre_director: @pelicula.nombre_director, paisdeorigen: @pelicula.paisdeorigen, sinopsis: @pelicula.sinopsis, titulo: @pelicula.titulo } }
    end
  ...
  test "should update pelicula" do
    patch pelicula_url(@pelicula), params: { pelicula: { calificacion: @pelicula.calificacion, duracion: @pelicula.duracion, genero: @pelicula.genero, nombre_director: @pelicula.nombre_director, paisdeorigen: @pelicula.paisdeorigen, sinopsis: @pelicula.sinopsis, titulo: @pelicula.titulo } }
